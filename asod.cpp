...
void QuickSort1(int L, int R)
{
    ...
    while (i <= j)
    {
        ...
        if (i <= R)
            C++; // последнее сравнение, которое вернуло false
